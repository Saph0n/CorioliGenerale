export const MedicalTemplates = {
  ...
  ricette: [
    ...
    {
      label: "Anticoagulanti orali - dosi e criteri di riduzione",
      text: "ANTICOAGULANTI ORALI DIRETTI - DOSI E CRITERI DI RIDUZIONE\n\nElenco di consultazione nella fibrillazione atriale non valvolare. La scelta\ndella molecola e della dose resta clinica.\n\nI criteri delle schede tecniche usano la clearance della creatinina secondo\nCockcroft-Gault, non l'eGFR: il referto della visita riporta entrambi, e nel\npaziente anziano o di basso peso i due numeri divergono proprio dove la\nriduzione di dose si decide.\n\nAPIXABAN\n- 5 mg due volte al giorno.\n- 2,5 mg due volte al giorno se ricorrono almeno due fra: eta' >= 80 anni,\n  peso <= 60 kg, creatininemia >= 1,5 mg/dL.\n- 2,5 mg due volte al giorno anche con ClCr fra 15 e 29 mL/min.\n- Non raccomandato con ClCr < 15 mL/min o in dialisi.\n\nRIVAROXABAN\n- 20 mg una volta al giorno, con il pasto.\n- 15 mg una volta al giorno con ClCr fra 15 e 49 mL/min.\n- Non raccomandato con ClCr < 15 mL/min.\n\nEDOXABAN\n- 60 mg una volta al giorno.\n- 30 mg una volta al giorno se: ClCr fra 15 e 50 mL/min, oppure peso <= 60 kg,\n  oppure terapia con ciclosporina, dronedarone, eritromicina o ketoconazolo.\n- Non raccomandato con ClCr < 15 mL/min.\n- Da evitare con ClCr > 95 mL/min: nello studio registrativo l'efficacia\n  risultava inferiore al warfarin in questa fascia.\n\nDABIGATRAN\n- 150 mg due volte al giorno.\n- 110 mg due volte al giorno se eta' >= 80 anni o in terapia con verapamil.\n- 110 mg due volte al giorno da considerare fra 75 e 80 anni, con ClCr fra 30\n  e 50 mL/min, con gastrite o reflusso, o comunque a rischio emorragico\n  aumentato.\n- Controindicato con ClCr < 30 mL/min.\n\nCONTROLLI\n- Funzione renale almeno una volta l'anno; con ClCr <= 60 mL/min piu' spesso.\n  Regola pratica: mesi di intervallo pari a ClCr diviso 10.\n- Emocromo e funzione epatica secondo il quadro clinico.\n- Rivalutare la dose a ogni variazione di peso, funzione renale o terapia\n  concomitante.\n\nDA NON DIMENTICARE\n- I DOAC sono controindicati nella protesi valvolare meccanica e nella\n  stenosi mitralica moderata-severa: li' resta il warfarin.\n- Non sospendere autonomamente. Segnalare ogni sanguinamento e ogni nuovo\n  farmaco assunto.",
    },
    {
